...
class FindFolderType extends BaseRequestType
{
    ...
    {
        $this->indexedPageFolderView = $this->castValueIfNeeded("indexedPageFolderView", $value);
        return $this;
    }
    ...
    {
        $this->fractionalPageFolderView = $this->castValueIfNeeded("fractionalPageFolderView", $value);
        return $this;
    }
