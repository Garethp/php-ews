...
class ServiceConfigurationResponseMessageType extends ResponseMessageType
{
    ...
    /**
     * @var \garethp\ews\API\Type\PolicyNudgeRulesServiceConfigurationType
     */
    protected $policyNudgeRulesConfiguration = null;

    /**
     * @var \garethp\ews\API\Type\SharePointURLsServiceConfigurationType
     */
    protected $sharePointURLsConfiguration = null;
    ...
    /**
     * @autogenerated This method is safe to replace
     * @return \garethp\ews\API\Type\PolicyNudgeRulesServiceConfigurationType
     */
    ...
    /**
     * @autogenerated This method is safe to replace
     * @param $value \garethp\ews\API\Type\PolicyNudgeRulesServiceConfigurationType
     * @return ServiceConfigurationResponseMessageType
     */
    public function setPolicyNudgeRulesConfiguration(\garethp\ews\API\Type\PolicyNudgeRulesServiceConfigurationType $value)
    {
    ...
    /**
     * @autogenerated This method is safe to replace
     * @return \garethp\ews\API\Type\SharePointURLsServiceConfigurationType
     */
    public function getSharePointURLsConfiguration()
    {
        return $this->sharePointURLsConfiguration;
    }

    /**
     * @autogenerated This method is safe to replace
     * @param $value \garethp\ews\API\Type\SharePointURLsServiceConfigurationType
     * @return ServiceConfigurationResponseMessageType
     */
    public function setSharePointURLsConfiguration(\garethp\ews\API\Type\SharePointURLsServiceConfigurationType $value)
    {
