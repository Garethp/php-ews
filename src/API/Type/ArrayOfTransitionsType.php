...
class ArrayOfTransitionsType extends Type
{
    ...
    /**
     * @autogenerated This method is safe to replace
     * @param $value AbsoluteDateTransition[]|AbsoluteDateTransition
     * @return ArrayOfTransitionsType
     */
    public function setAbsoluteDateTransition(array|AbsoluteDateTransition $value)
    {
        if (!is_array($value)) {
            $value = [$value];
        }
    ...
    /**
     * @autogenerated This method is safe to replace
     * @param $value RecurringDayTransition[]|RecurringDayTransition
     * @return ArrayOfTransitionsType
     */
    public function setRecurringDayTransition(array|RecurringDayTransition $value)
    {
        if (!is_array($value)) {
            $value = [$value];
        }
    ...
    /**
     * @autogenerated This method is safe to replace
     * @param $value RecurringDateTransition[]|RecurringDateTransition
     * @return ArrayOfTransitionsType
     */
    public function setRecurringDateTransition(array|RecurringDateTransition $value)
    {
        if (!is_array($value)) {
            $value = [$value];
        }
    ...
    /**
     * @autogenerated This method is safe to replace
     * @param $value Transition[]|Transition
     * @return ArrayOfTransitionsType
     */
    public function setTransition(array|Transition $value)
    {
        if (!is_array($value)) {
            $value = [$value];
        }
