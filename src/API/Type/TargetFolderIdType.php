...
class TargetFolderIdType extends Type
{
    ...
    /**
     * @var \garethp\ews\API\Type\AddressListIdType
     */
    protected $addressListId = null;
    ...
    /**
     * @autogenerated This method is safe to replace
     * @param $value AddressListIdType
     * @return TargetFolderIdType
     */
    public function setAddressListId(AddressListIdType $value)
    {
