...
class ArrayOfAttendeeConflictDataType extends Type
{
    ...
    /**
     * @autogenerated This method is safe to replace
     * @param $value UnknownAttendeeConflictDataType[]|UnknownAttendeeConflictDataType
     * @return ArrayOfAttendeeConflictDataType
     */
    public function setUnknownAttendeeConflictData(array|UnknownAttendeeConflictDataType $value)
    {
        if (!is_array($value)) {
            $value = [$value];
        }
     ...
     * @autogenerated This method is safe to replace
     * @param $value
     * TooBigGroupAttendeeConflictDataType[]|TooBigGroupAttendeeConflictDataType
     * @return ArrayOfAttendeeConflictDataType
     */
    public function setTooBigGroupAttendeeConflictData(array|TooBigGroupAttendeeConflictDataType $value)
    {
        if (!is_array($value)) {
            $value = [$value];
        }
