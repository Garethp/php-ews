...
class BaseFolderType extends Type
{
     ...
     * @return BaseFolderType
     */
    public function setDistinguishedFolderId($value)
    {
     ...
     * @return BaseFolderType
     */
    public function addReplicaList($value)
    {
        if ($this->replicaList === null) {
                        $this->replicaList = array();
        }

        if (!is_array($this->replicaList)) {
            $this->replicaList = array($this->replicaList);
        }
     ...
     * @return BaseFolderType
     */
    public function setReplicaList(array|string $value)
    {
        if (!is_array($value)) {
            $value = [$value];
        }
