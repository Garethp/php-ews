...
class MailTipsType extends Type
{
    ...
    /**
     * @var \garethp\ews\API\Type\RecipientSuggestionType[]
     */
    protected $recipientSuggestions = null;

    /**
     * @var boolean
     */
    protected $preferAccessibleContent = null;
    ...
    /**
     * @autogenerated This method is safe to replace
     * @param $value RecipientSuggestionType
     * @return MailTipsType
     */
    public function addRecipientSuggestions(RecipientSuggestionType $value)
    {
        if ($this->recipientSuggestions === null) {
                        $this->recipientSuggestions = array();
        }

        if (!is_array($this->recipientSuggestions)) {
            $this->recipientSuggestions = array($this->recipientSuggestions);
        }
    ...
    /**
     * @autogenerated This method is safe to replace
     * @param $value RecipientSuggestionType[]|RecipientSuggestionType
     * @return MailTipsType
     */
    public function setRecipientSuggestions(array|RecipientSuggestionType $value)
    {
        if (!is_array($value)) {
            $value = [$value];
        }
     ...
     * @return bool
     */
    public function isPreferAccessibleContent()
    {
        return ((bool) $this->preferAccessibleContent);
    }
     ...
     * @return boolean
     */
    public function getPreferAccessibleContent()
    {
        return $this->preferAccessibleContent;
    }
     ...
     * @return MailTipsType
     */
    public function setPreferAccessibleContent($value)
    {
        $this->preferAccessibleContent = $value;
        return $this;
    }
}
